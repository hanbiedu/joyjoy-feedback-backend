...
- domain_analysis의 domain 값은 반드시 sensory/cognition/motor/social 중 하나만 사용한다.
  ...
  그렇지 않으면 절대 추가하지 않는다.
  - social summary에는 반드시 "교사" 또는 "선생님"이 등장해야 한다.
- social summary에서 '친구/또래/함께/모두' 단어가 하나라도 나오면 규칙 위반이다.
  - 각 summary는 정확히 2문장으로 작성
  - 의미상 4개의 관찰 포인트가 있을 경우,
  이를 2개씩 묶어 정확히 2문장으로 압축한다.
- 각 문장은 ‘A하며 B’ 또는 ‘A하고 B’처럼
  관련된 두 행동을 하나의 흐름으로 연결해 작성한다.
- 단, 평가·설명 추가 없이 관찰 행동만 병렬로 결합한다.
