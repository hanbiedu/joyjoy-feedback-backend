...
document.addEventListener("DOMContentLoaded", () => {
  ...
  autoBtn?.addEventListener("click", async (e) => {
    e.preventDefault();
    console.log("🤖 AI 자동 생성 클릭!");

    // 🔥 선택된 value를 items 배열에 담기 (핵심 수정)
    const itemsArray = [
    ...
    console.log("📤 AI 자동 생성 payload:", payload);
    ...
    try {
      ...
      console.log("📤 저장용 saveData:", saveData);
